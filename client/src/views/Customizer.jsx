...
import {AIPicker, ColorPicker, RegularButton, FilePicker, Tab} from '../components';
  ...
  const handleSubmit = async (type) =>{
    ...
    try{
      ...
      if(data.photo != null){
        ...
        alert("Could not generate image. Please try again later.");
        console.log(data)
      }
      ...
      {!snap.intro && (
        <>
          ...
          <motion.div className='absolute z-10 top-5 right-5' {...fadeAnimation}>
            <RegularButton type='filled' title='Go Back' handleClick={()=>{state.intro = true}} customStyle="w-fit px-4 py-2.5 font-bold text-sm"/>
          </motion.div>
