...
const FilePicker = ({file, setFile, readFile}) => {
  ...
  return (
    <div className='filepicker-container'>
      ...
      <RegularButton type="outline" title="Logo" handleClick={()=>{readFile('logo')}} customeStyle="text-xs" />
      <RegularButton type="filled" title="Full" handleClick={()=>{readFile('full')}} customeStyle="text-xs" />
      </div>
